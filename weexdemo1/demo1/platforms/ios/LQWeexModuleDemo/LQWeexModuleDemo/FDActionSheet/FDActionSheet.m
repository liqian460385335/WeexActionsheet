...
/* IPHONEX的自定义导航 间距适配*/
#define IPHONE_X_SPACEHRIGHT ((SCREEN_HEIGHT == 812) ? 20.0 : 0)
...
- (void)initCancelButton {
    if (_cancelButtonTitle != nil) {
        ...
        contentViewHeight += SPACE_SMALL + _cancelButton.frame.size.height + SPACE_SMALL+(IPHONEX ? IPHONE_X_SPACEHRIGHT : 0);
    }
}
