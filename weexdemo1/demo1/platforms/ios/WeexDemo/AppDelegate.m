...
//    LQWeexModuleDemo * lqModule = [LQWeexModuleDemo new];
    [self setWeexSDK];
...
- (void)setWeexSDK{
    ...
    //注册事件处理
    [WXSDKEngine registerModule:@"LQWeex" withClass:[LQWeexModuleDemo class]];
    [WXLog setLogLevel:WXLogLevelDebug];
    
    //actionSheet
    [WXSDKEngine registerModule:@"CDDActionSheet" withClass:[CDDActionSheetModule class]];
